	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-success">
				<div class="box-header">
					<h3 class="box-title">새 답글 달기</h3>
				</div>
				<div class="box-body">
					<label for="exampleInputEmail1">작성자</label> <input
						class="form-control" type="text" placeholder="USER ID"
						id="newReplyWriter"> <label for="exampleInputEmail1">
						작성내용</label> <input class="form-control" type="text"
						placeholder="내용을 작성하세요." id="newReplyText">

				</div>
				<!-- /.box-body -->
				<div class="box-footer">
					<button type="button" class="btn btn-primary" id="replyAddBtn">답글 달기</button>
				</div>
			</div>
		...
		<li class="time-label" id="repliesDiv">
		  <span class="bg-green">
		    답글 목록<small id='replycntSmall'> [ ${boardVO.replycnt} ] </small>
		    </span>
		  </li>
		</ul>
  ...
  <div class="timeline-body">{{replytext}} </div>
    <div class="timeline-footer">
     <a class="btn btn-primary btn-xs" 
	    data-toggle="modal" data-target="#modifyModal">수정하기</a>
    </div>
  </div>			
</li>
{{/each}}
